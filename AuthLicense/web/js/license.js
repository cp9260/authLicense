        ...
        success: function (contact) {
            ...
            for (var i = 0; i < allData.length; i++) {
                ...
                html += '<tr id="show_tab_tr" idx="' + i + '" >' +
                    ...
                    '<td key="ip" ><input  type="text" value="' + data.ip + '" disabled  ></td>' +
                    '<td key="domain"><input  type="text" value="' + data.domain + '"  disabled ></td>' +
                    '<td key="licenseKey" ><input  type="text" value="' + data.licenseKey + '" disabled  ></td>' +
