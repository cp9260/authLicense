...
<html>
  <head>
	...
	-->
		...
		#bgbox{ width: 700px; height: 515px; margin: 150px auto; background: url(images/bg12.png) 0 0 no-repeat;  overflow: hidden;}
  ...
  <div id="bgbox">
    <form action="login" method="post">
			...
			<a href="register.jsp">注册</a> <input type="submit" value="登录" class="button">
	</form>
	</div>
  </body>
</html>
